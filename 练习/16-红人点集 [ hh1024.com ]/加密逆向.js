// 扣代码实现加密
function encrypt_extract_js(n) {
    var a = 0;  // 控制密文的大小写，为0是小写，非0是大写
    // n 为密码明文字符串
    function i(n) {
        return c(o(s(n)))
    }
...
// 直接使用 crypto-js 加解密工具包
function encrypt_crypto_js(n) {
...
function get_pwd(n) {
    // 扣代码实现
    return encrypt_extract_js(n);
    // 直接使用 crypto-js 加解密包
    // return encrypt_crypto_js(n);
}
